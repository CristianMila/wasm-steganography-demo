...
let exports1EncodeSecretIntoBmp;

function encodeSecretIntoBmp(arg0, arg1) {
  ...
  _debugLog('[iface="encode-secret-into-bmp", function="encode-secret-into-bmp"] [Instruction::CallWasm] (async? false, @ enter)');
  const _wasm_call_currentTaskID = startCurrentTask(0, false, 'exports1EncodeSecretIntoBmp');
  const ret = exports1EncodeSecretIntoBmp(ptr0, len0, ptr1, len1);
  endCurrentTask(0);
  ...
  _debugLog('[iface="encode-secret-into-bmp", function="encode-secret-into-bmp"][Instruction::Return]', {
    funcName: 'encode-secret-into-bmp',
    paramCount: 1,
    postReturn: true
  });
...
let exports1DecodeSecretFromBmp;

function decodeSecretFromBmp(arg0) {
  if (!_initialized) throwUninitialized();
  var val0 = arg0;
  var len0 = val0.byteLength;
  ...
  var src0 = new Uint8Array(val0.buffer || val0, val0.byteOffset, len0 * 1);
  (new Uint8Array(memory0.buffer, ptr0, len0 * 1)).set(src0);
  _debugLog('[iface="decode-secret-from-bmp", function="decode-secret-from-bmp"] [Instruction::CallWasm] (async? false, @ enter)');
  const _wasm_call_currentTaskID = startCurrentTask(0, false, 'exports1DecodeSecretFromBmp');
  const ret = exports1DecodeSecretFromBmp(ptr0, len0);
  endCurrentTask(0);
  var ptr1 = dataView(memory0).getUint32(ret + 0, true);
  var len1 = dataView(memory0).getUint32(ret + 4, true);
  var result1 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr1, len1));
  _debugLog('[iface="decode-secret-from-bmp", function="decode-secret-from-bmp"][Instruction::Return]', {
    funcName: 'decode-secret-from-bmp',
    paramCount: 1,
    postReturn: true
  });
...
export const $init = (() => {
  let gen = (function* init () {
    ...
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    postReturn0 = exports1['cabi_post_decode-secret-from-bmp'];
    _initialized = true;
    exports1EncodeSecretIntoBmp = exports1['encode-secret-into-bmp'];
    exports1DecodeSecretFromBmp = exports1['decode-secret-from-bmp'];
  })();
...
export { decodeSecretFromBmp, encodeSecretIntoBmp,  }